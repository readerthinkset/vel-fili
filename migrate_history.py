"""
Migrate phrase history to Filipino format
Converts legacy keys ('japanese', 'telugu', 'korean') -> 'filipino'
...
if HISTORY_FILE.exists():
    ...
    print(f"Migrated {updated_count} phrases to Filipino format")
    if updated_count > 0:
    ...
    print("Ready for new Filipino content generation")
else:
